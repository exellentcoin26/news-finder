    ...
    return (
            <Container>
                ...
                <Row>
                    ...
                    <h2>Functionality</h2>
                        <ul>
                        <li>News articles are pulled from a variety of sources and displayed in a single location</li>
                        <li>Users can filter articles by category</li>
                        <li>Article summaries and images are displayed for easy browsing</li>
                        <li>Users can click on individual articles to read the full story on the source website</li>
                        <li>Articles are updated in real-time as new content becomes available</li>
                        <li>Users gets articles recommended by a recommendation system</li>
                        <li>For a better view similar articles are also group together</li>
                        </ul>
                    </Col>
                </Row>
            </Container>
